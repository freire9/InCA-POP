<script>
    ...
    const expLabel = popElmntType.EXP;
...
<div class="checkbox-flex">
    ...
    <input id="enableExpPopElmntInnerFigContour" type="checkbox" bind:checked={$gameSettings.popElmntConfig[popElmntType.EXP].enableInnerFigContour} on:input={handleUpdateRemotePreferences}>
</div>
